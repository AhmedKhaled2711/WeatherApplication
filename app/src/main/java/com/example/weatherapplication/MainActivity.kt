...
import com.example.weatherapplication.settings.TickHandler
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var handler : TickHandler
...
//        Log.i("sp", "$selectedLanguage ")
        ...
        handler = TickHandler(externalScope,tickIntervalMs,this)
        job = externalScope.launch {
            handler.tickFlow.collect{
                language = it
            }
        }
